...
function createConfirmMessage() {
    ...
    let confirmH2userNameText = document.createElement('p');
    confirmH2userNameText.innerText = 'You have successfully registered as: ' + FoodPlate.user.userName;
    confirmH2userName.appendChild(confirmH2userNameText);
    ...
    let confirmPAgeText = document.createElement('p');
    confirmPAgeText.innerText = 'Your age group is: ' + FoodPlate.user.ageGroup;
    confirmPAge.appendChild(confirmPAgeText);
    ...
    let confirmPGenderText = document.createElement('p');
    confirmPGenderText.innerText = 'Your gender is ' + selectedGender;
    confirmPGender.appendChild(confirmPGenderText);
